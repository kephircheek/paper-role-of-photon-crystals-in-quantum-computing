...
Первые попытки (Yoshie 2004) продемонстрировать квантовую природу взаимодействия между резонатором маленького объема и квантовой точки были не удачными. Полученные асциляции Рабби могли быть описаны полуклассическими методами. Подтвердить квантовую природу взаимодействия удалось только в 2007 году (Hennessy 2007).

## Выводы
Фотонные кристаллы являются удобной площадкой исследования взаимодействия материи и света, а также являются перспективной площадкой для квантовых устройств, основанных на когерентном рассеянии света на квантовых точках в микрорезонаторах.
...
Это является главным ограничением развития квантовых платформ на их основе.

Ввиду более высокой экспериментальной доступности широкое распространение получила близкая по смыслу платформа, основанная на ионах захваченные в ловушки Пауля.
На этой платформы были продемонстрировать преимущества сети основанной на фотонах, например недавно удалось запутать два удаленных на 230 метров кубита (Krutyanskiy 2023).
